...
public:
	...
	virtual void processFace(std::string filename, int16_t page, int64_t offset, std::string region, std::string* workDir) = 0;
};
...
private:
	...
	void readFace(std::vector<std::string> tokens);
	void readFace(DataCNFTag tag, DataCNFTag nextTag);
